...
import { StorageBrowser } from '@/features/projects/components/storage-browser';
...
export default async function ProjectStoragePage({
  ...
  const t = await getTranslations('projects.storage');
    ...
    <>
      ...
      <main className="min-h-0 flex-1 overflow-y-auto px-6 py-8 lg:px-10 lg:py-10">
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-6">
          ...
          <StorageBrowser projectId={project.id} />
        </div>
      </main>
    </>
  );
